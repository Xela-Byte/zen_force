  ...
  const allSteps: Step[] = [
    {
      ...
      stepComponent: (
        <StepOne handleStep={handleStep} storeVettingData={storeVettingData} />
      ),
    },
    {
      stepName: '2',
      ...
      stepComponent: (
        <StepTwo handleStep={handleStep} storeVettingData={storeVettingData} />
      ),
    },
    {
      stepName: '3',
    ...
    },
    {
      ...
      stepComponent: (
        <StepFour handleStep={handleStep} storeVettingData={storeVettingData} />
      ),
    },
    {
      stepName: '5',
